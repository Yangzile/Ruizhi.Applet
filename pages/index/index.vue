<template>
	<view class="home">
		<!-- 首页轮播图 -->
		<view class="swiper-box"><u-swiper :list="swiperList" mode="round" :effect3d="true" height="500" interval="2000" border-radius="50" @click="SwiperClick"></u-swiper></view>
		<!-- 导航 -->
		<view class="navber-box">
			<u-row>
				<u-col span="6" v-for="(item, index) in navList" :key="index" @click="goPages(item.path)">
					<view class="nav-item">
						<view class="left">
